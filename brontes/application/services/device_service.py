from brontes.infrastructure.repos import DeviceRepository, PointRepository
from brontes.domain.models import Device
  ...
  def get_device_graphic(self, facility_uri: str, device_uri: str):
    ...
    if graphic is not None:
      ...
      for point in points:
        ...
        if element is not None and point.value is not None and point.object_units is not None:
